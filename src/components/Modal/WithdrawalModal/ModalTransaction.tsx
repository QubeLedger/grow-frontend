...
import { useShowTransactionModalW } from '../../../hooks/useShowModal';
...
export const WithdrawalModalTransaction = () => {
    ...
    const open = () => { setShowTransactionModalW({ b: true }) };
    const close = () => { setShowTransactionModalW({ b: false }) };
    const [ShowTransactionModalW, setShowTransactionModalW] = useShowTransactionModalW();
    const [theme, setTheme] = useToggleTheme()

    return (
        <OpenButtonBlock>
            <OpenButton onClick={open}>Confirm</OpenButton>
            <StyledDialogOvelay isOpen={ShowTransactionModalW.b} onDismiss={close}>
