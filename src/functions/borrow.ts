...
export async function CreateBorrow(amtIn: AmountIn, wallet: Wallet, client: Client) {
        try {
...
export async function DeleteBorrow(amtIn: AmountIn, wallet: Wallet, client: Client) {
        try {
